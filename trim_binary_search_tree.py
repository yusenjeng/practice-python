...
def trim_bst(tree, minv, maxv):
    if not tree:
        return

    tree.left_branch = trim_bst(tree.left_branch, minv, maxv)
    tree.right_branch = trim_bst(tree.right_branch, minv, maxv)

    if minv <= tree.key <= maxv:
        return tree
